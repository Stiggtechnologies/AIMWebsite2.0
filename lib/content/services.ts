...
export const services: Service[] = [
  ...
  },
  {
    ...
    name: 'Manual Osteopathic Therapy',
    shortDescription: 'Gentle, hands-on care focused on movement, comfort, and individual goals.',
    positioning: 'Manual osteopathic therapy uses gentle, hands-on techniques to address movement restrictions and support comfort. Care is tailored to your assessment and goals.',
    helps: ['Persistent stiffness', 'Mobility restrictions', 'Recurring musculoskeletal discomfort', 'Movement compensation patterns'],
    treatmentMay: ['Soft tissue techniques', 'Myofascial techniques', 'Gentle joint mobilization', 'Movement guidance'],
    whoFor: ['Adults seeking gentle hands-on care', 'People with recurring stiffness or mobility restrictions', 'Patients using complementary care alongside other services'],
    whyAim: ['Individual assessment and care planning', 'Clear complementary-care scope', 'Coordination with other AIM services when appropriate', 'Benefit coverage guidance before treatment'],
    faqs: [
      { q: 'Is manual osteopathic therapy the same as physiotherapy?', a: 'No. Manual osteopathic therapy is a complementary service and is not physiotherapy or medical diagnosis.' },
      { q: 'Is it covered by benefits?', a: 'Coverage varies by extended health plan. It is not covered by WCB or motor vehicle insurance. Confirm your plan requirements before treatment.' },
      { q: 'What happens at the first visit?', a: 'Your practitioner reviews your goals and movement concerns, completes an assessment within their scope, and discusses whether manual osteopathic therapy is appropriate for you.' },
    ],
    icon: 'Hand',
    category: 'complementary',
  },
  {
    slug: 'orthotics',
    name: 'Foot Orthotics',
    shortDescription: 'Assessment-led foot orthotics fitting and follow-up in Edmonton.',
    positioning: 'Foot orthotics recommendations based on an individual assessment, your footwear, daily activities, and comfort goals.',
    helps: ['Recurring foot discomfort', 'Footwear pressure or fit concerns', 'Standing and walking demands', 'Activity-related foot support needs'],
    treatmentMay: ['Foot and movement assessment', 'Footwear review', 'Orthotics recommendation', 'Fitting and follow-up'],
    whoFor: ['People who spend long hours standing or walking', 'Active adults with recurring foot concerns', 'People seeking individualized in-shoe support'],
    whyAim: ['Assessment before recommendation', 'Attention to footwear and daily activity needs', 'Fitting and follow-up', 'Benefit-plan documentation guidance'],
    faqs: [
      { q: 'Do I need a referral or prescription?', a: 'Requirements vary by benefit plan. Contact your insurer before the assessment if you intend to claim the device.' },
      { q: 'Are foot orthotics covered by benefits?', a: 'Some extended health plans cover foot orthotics, but eligibility, prescriber requirements, device specifications, and reimbursement limits vary.' },
      { q: 'What should I bring to the assessment?', a: 'Bring the shoes you wear most often, any existing orthotics, and your benefit-plan requirements if you plan to submit a claim.' },
      { q: 'Will everyone receive an orthotic?', a: 'No. The recommendation depends on the assessment, your needs, and whether an orthotic is appropriate for your goals.' },
    ],
    icon: 'Footprints',
    category: 'complementary',
  },
